		...
		<div className="space-y-6">
			...
			<div className="space-y-4">
				{comments.map((comment) => (
					<div key={comment.id} className="bg-card rounded-lg p-4 space-y-2 border border-text-secondary/10">
						<div className="flex items-center gap-2">
							...
							<div>
								...
								<p className="text-sm text-text-secondary">{comment.timestamp}</p>
							</div>
						</div>
